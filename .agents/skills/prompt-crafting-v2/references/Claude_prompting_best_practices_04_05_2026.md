...
Source URL:    https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-prompting-best-practices.md
Fetched:       2026-05-04
Applies to:    Claude Opus 4.7, Claude Opus 4.6, Claude Sonnet 4.6, Claude Haiku 4.5
Regenerated by: scripts/regenerate_references.py (sources.yaml entry: claude_prompting_best_practices)

This file is a verbatim cache of the source page above, kept inside the
